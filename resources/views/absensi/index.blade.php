...
@section('content')
    <div class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 p-6 rounded-2xl shadow-2xl w-full min-h-screen">
        <h1 class="text-3xl font-bold mb-6 text-white text-center">Data Absensi</h1>
        ...
        <div class="flex justify-between mb-6">
            <input
                type="text"
                id="searchInput"
                placeholder="Cari ID, Staff ID, atau Tanggal..."
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
                    <tr>
                        ...
                        <th class="p-4 text-left font-semibold">Login Time</th>
                        <th class="p-4 text-left font-semibold">Logout Time</th>
                        <th class="p-4 text-left font-semibold">Status</th>
                        <th class="p-4 text-center font-semibold">Aksi</th>
                    </tr>
                </thead>
                <tbody id="dataAbsensi" class="text-white">
                    <tr>
        ...
        @include('components.absensi.modal-add')

        {{-- Include Modal Edit --}}
        @include('components.absensi.modal-edit')

        {{-- Script --}}
        <script src="{{ asset('js/Absensi/absensi.js') }}"></script>
        <script src="{{ asset('js/Absensi/absensi-create.js') }}"></script>
        <script src="{{ asset('js/Absensi/absensi-edit.js') }}"></script>
    </div>
@endsection