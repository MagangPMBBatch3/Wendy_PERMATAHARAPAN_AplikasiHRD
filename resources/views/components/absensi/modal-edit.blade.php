...
<div id="editModal" class="hidden fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm z-50 flex items-center justify-center p-4 transition-opacity duration-300">
  <div class="bg-indigo-900/95 border border-indigo-700 shadow-2xl rounded-xl w-full max-w-md max-h-[85vh] overflow-hidden flex flex-col">
    ...
    <div class="p-6 space-y-5 overflow-y-auto max-h-[60vh]">
      ...
      <!-- Payroll -->
      <div class="space-y-2">
        <label for="editPayrollId" class="block text-sm font-medium text-gray-200">
          Payroll <span class="text-red-400 ml-1">*</span>
        </label>
        <div class="relative">
      ...
      <!-- Lembur -->
      <div class="space-y-2">
        <label for="editLembur" class="block text-sm font-medium text-gray-200">
          Lembur
        </label>
        <div class="relative">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-indigo-300">
          ...
          <input
            ...
            step="0.01"
            class="w-full pl-10 pr-4 py-3 bg-slate-800/70 text-white placeholder-gray-400 rounded-lg border border-slate-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
            placeholder="Masukkan jumlah lembur"
          >
        </div>
      </div>
      ...
      <!-- Bonus -->
      <div class="space-y-2">
        <label for="editBonus" class="block text-sm font-medium text-gray-200">
          Bonus
        </label>
        <div class="relative">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-indigo-300">
      ...
      <!-- Pengurangan -->
      <div class="space-y-2">
        <label for="editPengurangan" class="block text-sm font-medium text-gray-200">
          Pengurangan
        </label>
        <div class="relative">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-indigo-300">
      ...
      <!-- Total Gaji -->
      <div class="space-y-2">
        <label for="editTotalGaji" class="block text-sm font-medium text-gray-200">
          Total Gaji <span class="text-red-400 ml-1">*</span>
        </label>
        <div class="relative">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-indigo-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="space-y-2">
        ...
        <div class="relative">
          ...
          <textarea
            ...
            placeholder="Masukkan keterangan detail payroll"
          ></textarea>
        </div>
      </div>
      ...
      <div class="pt-2 flex gap-3 justify-end">
        ...
        <button
          type="button"
          onclick="updateDetailPayroll(); return false;"
