<div id="modalEdit" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-indigo-900 p-6 rounded-lg shadow-lg w-96 max-h-[90vh] overflow-y-auto">
        <h2 class="text-xl font-bold mb-4 text-white">Edit User</h2>
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="email" id="editEmail" required class="w-full p-2 bg-slate-700 text-white rounded">
            </div>
            <div>
                <label class="block text-gray-300 mb-1">Password <small>(leave blank to keep unchanged)</small></label>
                <input type="password" id="editPassword" class="w-full p-2 bg-slate-700 text-white rounded">
            </div>
            <div>
                <label class="block text-gray-300 mb-1">Email Verified At</label>
                <input type="datetime-local" id="editEmailVerifiedAt" class="w-full p-2 bg-slate-700 text-white rounded">
            </div>
            <div class="flex gap-4 justify-end pt-4">
                ...
                <button type="button" onclick="updateUser(); return false;" 
