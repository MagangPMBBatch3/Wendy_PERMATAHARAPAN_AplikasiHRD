...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Detail Payroll Management</h1>
        <button onclick="crud.openCreate()" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add New Detail</button>
    </div>

    <div class="mb-6 flex gap-4">
        <div class="flex-1">
            <input type="text" id="searchInput" placeholder="Search details..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        ...
        <table class="min-w-full">
            <thead class="bg-gray-100 border-b">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-sm font-semibold">Payroll</th>
...
<div id="formModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-8 w-96 max-h-96 overflow-y-auto">
        <div class="flex justify-between items-center mb-6">
            <h2 id="modalTitle" class="text-2xl font-bold">Add New Detail</h2>
        ...
        <form id="crud-form" class="space-y-4">
            <div>
                ...
                <select id="payroll_id" name="payroll_id" required class="w-full px-3 py-2 border border-gray-300 rounded-lg"></select>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" id="jumlah" name="jumlah" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
            </div>
...
<script src="/js/DetailPayroll/detailpayroll-crud.js"></script>
@endsection
