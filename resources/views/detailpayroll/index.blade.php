...
@section('content')
    <div class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 p-6 rounded-2xl shadow-2xl w-full min-h-screen">
        <h1 class="text-3xl font-bold mb-6 text-white text-center">Data Detail Payroll</h1>
        ...
        <div class="flex justify-between mb-6">
            <input
                type="text"
                id="searchInput"
                placeholder="Cari ID, Payroll, atau Staff..."
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
                    <tr>
                        ...
                        <th class="p-4 text-left font-semibold">Payroll</th>
                ...
                <tbody id="dataDetailPayroll" class="text-white">
                    <tr>
        ...
        @include('components.detailpayroll.modal-add')

        {{-- Include Modal Edit --}}
        @include('components.detailpayroll.modal-edit')

        {{-- Script --}}
        <script src="{{ asset('js/DetailPayroll/detailpayroll.js') }}"></script>
        <script src="{{ asset('js/DetailPayroll/detailpayroll-create.js') }}"></script>
        <script src="{{ asset('js/DetailPayroll/detailpayroll-edit.js') }}"></script>
    </div>
@endsection