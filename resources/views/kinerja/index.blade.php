...
@section('content')
    <div class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 p-6 rounded-2xl shadow-2xl w-full min-h-screen">
        <h1 class="text-3xl font-bold mb-6 text-white text-center">Data Kinerja</h1>
        ...
        <div class="flex justify-between mb-6">
            <input
                type="text"
                id="searchInput"
                placeholder="Cari ID, Staff, atau Periode..."
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
                    <tr>
                        ...
                        <th class="p-4 text-left font-semibold">Periode</th>
                        <th class="p-4 text-left font-semibold">Nilai</th>
                        <th class="p-4 text-left font-semibold">Penilai</th>
                        <th class="p-4 text-left font-semibold">Tanggal</th>
                        <th class="p-4 text-center font-semibold">Aksi</th>
                    </tr>
                </thead>
                <tbody id="dataKinerja" class="text-white">
                    <tr>
        ...
        @include('components.kinerja.modal-add')

        {{-- Include Modal Edit --}}
        @include('components.kinerja.modal-edit')

        {{-- Script --}}
        <script src="{{ asset('js/Kinerja/kinerja.js') }}"></script>
        <script src="{{ asset('js/Kinerja/kinerja-create.js') }}"></script>
        <script src="{{ asset('js/Kinerja/kinerja-edit.js') }}"></script>
    </div>
@endsection