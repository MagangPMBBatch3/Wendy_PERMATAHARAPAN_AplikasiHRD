...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Overtime</h1>
            <p class="text-gray-600">Update overtime record details</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('overtime.show', $overtime->id ?? '') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form id="editOvertimeForm" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <div id="currentPhoto" class="mt-2 hidden">
                    ...
                    <img id="currentPhotoImg" class="mt-1 max-w-xs h-auto rounded-md" alt="Current photo">
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('js/Overtime/overtime-edit.js') }}"></script>
@endpush
@endsection
