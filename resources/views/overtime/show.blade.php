...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Overtime Details</h1>
            <p class="text-gray-600">View detailed information about this overtime record</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('overtime.edit', $overtime->id ?? '') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <h4 class="text-lg font-semibold text-gray-900 mb-4">Overtime Information</h4>
            <div class="space-y-4">
                <!-- Date -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">Date</label>
                    <p id="overtimeDate" class="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">Loading...</p>
                </div>

                <!-- Start Time -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">Start Time</label>
                    <p id="overtimeStartTime" class="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">Loading...</p>
                </div>

                <!-- End Time -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">End Time</label>
                    <p id="overtimeEndTime" class="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">Loading...</p>
                </div>

                <!-- Duration -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">Duration</label>
                    <p id="overtimeDuration" class="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">Loading...</p>
                </div>

                <!-- Status -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">Status</label>
                    <p id="overtimeStatus" class="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md">Loading...</p>
                </div>

                <!-- Description -->
                <div>
                    <label class="block text-sm font-medium text-gray-700">Description</label>
                    <p id="overtimeDescription" class="mt-1 text-sm text-gray-900 bg-gray-50 px-3 py-2 rounded-md min-h-[3rem]">Loading...</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-4">
                ...
                <div id="photoSection" class="hidden">
                    ...
                    <div class="mt-1">
                        <img id="overtimePhoto" class="max-w-xs h-auto rounded-md shadow-sm" alt="Overtime photo">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Timeline -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h4 class="text-lg font-semibold text-gray-900 mb-4">Overtime Timeline</h4>
        <div class="space-y-4">
            <!-- Created -->
            <div class="flex items-center space-x-3">
                ...
                <div class="flex-1">
                    <p class="text-sm font-medium text-gray-900">Overtime Created</p>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Delete Overtime</h3>
                <p class="text-sm text-gray-500 mb-4">Are you sure you want to delete this overtime record? This action cannot be undone.</p>
