...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Update deduction details</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('pengurangan.show', $pengurangan->id ?? '') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form id="editDeductionForm" class="space-y-6">
            @csrf
...
@push('scripts')
<script src="{{ asset('js/Pengurangan/pengurangan-edit.js') }}"></script>
@endpush
@endsection
