    ...
    <div class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 p-6 rounded-2xl shadow-2xl w-full min-h-screen">
        ...
        <div class="flex justify-between mb-6">
            <input
                type="text"
                id="searchInput"
                placeholder="Cari Staff, Tanggal, atau Alasan..."
        ...
        <div class="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden shadow-2xl">
            <table class="w-full">
                ...
                <tbody id="dataPotonganTelat" class="text-white">
                    <tr>
        ...
        @include('components.pengurangantelat.modal-add')

        {{-- Include Modal Edit --}}
        @include('components.pengurangantelat.modal-edit')

        {{-- Script --}}
        <script src="{{ asset('js/PenguranganTelat/potongan-telat.js') }}"></script>
        <script src="{{ asset('js/PenguranganTelat/potongan-telat-create.js') }}"></script>
        <script src="{{ asset('js/PenguranganTelat/potongan-telat-edit.js') }}"></script>
    </div>
@endsection