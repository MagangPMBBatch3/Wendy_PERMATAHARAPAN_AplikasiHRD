...
@section('content')
    <div class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 p-6 rounded-2xl shadow-2xl w-full min-h-screen">
        <h1 class="text-3xl font-bold mb-6 text-white text-center">Data Staff</h1>
        ...
        <div class="flex justify-between mb-6">
            <input
                type="text"
                id="searchInput"
                placeholder="Cari ID, Nama, atau Level..."
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
                    <tr>
                        ...
                        <th class="p-4 text-left font-semibold">Hire Date</th>
                        <th class="p-4 text-left font-semibold">Salary</th>
                        <th class="p-4 text-left font-semibold">Points</th>
                        <th class="p-4 text-center font-semibold">Aksi</th>
                    </tr>
                </thead>
                <tbody id="dataStaff" class="text-white">
                    <tr>
        ...
        @include('components.staff.modal-add')

        {{-- Include Modal Edit --}}
        @include('components.staff.modal-edit')

        {{-- Script --}}
        <script src="{{ asset('js/Staff/staff.js') }}"></script>
        <script src="{{ asset('js/Staff/staff-create.js') }}"></script>
        <script src="{{ asset('js/Staff/staff-edit.js') }}"></script>
    </div>
@endsection