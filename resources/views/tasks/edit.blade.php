...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">Update task details and assignments</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('tasks.show', $task->id ?? '') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form id="editTaskForm" class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Task creator</p>
            </div>
            ...
            <div>
                ...
                <div id="currentAttachment" class="mt-2 hidden">
                    ...
                    <a id="currentAttachmentLink" href="#" target="_blank" class="text-blue-600 hover:text-blue-800 underline">View current attachment</a>
                </div>
            </div>
...
@push('scripts')
<script src="{{ asset('js/Tasks/tasks-edit.js') }}"></script>
@endpush
@endsection
