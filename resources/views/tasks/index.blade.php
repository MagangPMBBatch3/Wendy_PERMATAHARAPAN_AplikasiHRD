...
@section('content')
    <div class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 p-6 rounded-2xl shadow-2xl w-full min-h-screen">
        <h1 class="text-3xl font-bold mb-6 text-white text-center">Data Tasks</h1>
        ...
        <div class="flex justify-between mb-6">
            <input
                type="text"
                id="searchInput"
                placeholder="Cari ID, Title, atau Proyek..."
        ...
        <div class="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden shadow-2xl">
            <table class="w-full">
                ...
                <tbody id="dataTasks" class="text-white">
                    <tr>
        ...
        @include('components.tasks.modal-add')

        {{-- Include Modal Edit --}}
        @include('components.tasks.modal-edit')
