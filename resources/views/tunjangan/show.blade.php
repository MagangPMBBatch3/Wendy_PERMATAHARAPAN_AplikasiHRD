...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Allowance Details</h1>
            <p class="text-gray-600">View detailed information about this allowance</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('tunjangan.edit', $tunjangan->id ?? '') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <h4 class="text-lg font-semibold text-gray-900 mb-4">Allowance Information</h4>
            <div class="space-y-4">
                <!-- Type -->
                <div>
    ...
    <!-- Timeline -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h4 class="text-lg font-semibold text-gray-900 mb-4">Allowance Timeline</h4>
        <div class="space-y-4">
            <!-- Created -->
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Delete Allowance</h3>
                <p class="text-sm text-gray-500 mb-4">Are you sure you want to delete this allowance? This action cannot be undone.</p>
